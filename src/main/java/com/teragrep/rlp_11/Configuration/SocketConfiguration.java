...
/**
 * Configuration for socket values.
 * <p>
 * Socket expects positive values for milliseconds.
 */
public final class SocketConfiguration {
    ...
    public SocketConfiguration(final Map<String, String> config) {
        this.config = config;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (o == null) {
            ...
            final SocketConfiguration that = (SocketConfiguration) o;
