...
|`target.rebindamount`
|Number of events/reconnects before triggering a RELP Server connection rebind

|`target.rebind-enabled`
|Boolean flag to enable or disable RELP Server connection rebinding

|`target.maxidleseconds`
|RELP Server maximum idle connection duration, in seconds

|`target.maxidle-enabled`
|Boolean flag to enable or disable the maximum idle connection timeout

|`tls.enabled`
|Boolean flag to enable or disable TLS, disabled by default

|`tls.keystore.path`
|Path to TLS keystore, defaults to `/opt/teragrep/rlp_11/etc/keystore.p12`

|`tls.keystore.password`
|TLS keystore password

|`tls.protocol`
|TLS protocol to be used, defaults to `TLSv1.3`

|`socket.readtimeout`
|Socket read timeout, default 5000

|`socket.writetimeout`
|Socket write timeout, default 5000

|`socket.connecttimeout`
|Socket connect timeout, default 5000

|`socket.keepalive`
|Boolean flag to keep socket connection alive, default false
